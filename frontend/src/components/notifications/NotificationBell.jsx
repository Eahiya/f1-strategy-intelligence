      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 w-96 bg-gradient-to-b from-gray-900 to-black border border-gray-800 rounded-xl shadow-2xl z-50 overflow-hidden"
          >
            {/* Header */}
